  ...
  return {
      ...
      {QStringLiteral("attributes"),
       QJsonObject{{QStringLiteral("name"), QStringLiteral("Track")},
                   ...
                   {QStringLiteral("playParams"),
                    QJsonObject{{QStringLiteral("catalogId"), catalogId}}}}}};
}

void MediaModelTest::parsesLibrarySong() {
  const auto item =
      MediaItem::fromJson(song(QStringLiteral("i.123"), QStringLiteral("456")));
...
void MediaModelTest::replacesArtworkTemplate() {
  QCOMPARE(
      MediaItem::artwork(QStringLiteral("https://example/{w}x{h}.{f}"), 256),
      QStringLiteral("https://example/256x256.jpg"));
}
...
void MediaModelTest::usesCatalogArtworkForLibraryArtist() {
  const QJsonObject artist{
      ...
      {QStringLiteral("attributes"),
       QJsonObject{{QStringLiteral("name"), QStringLiteral("Artist")}}},
                      ...
                      QJsonObject{
                          {QStringLiteral("artwork"),
                           QJsonObject{
                               {QStringLiteral("url"),
                                QStringLiteral(
                                    "https://example/{w}x{h}.{f}")}}}}}}}}}}}}};

  QCOMPARE(MediaItem::fromJson(artist).artworkUrl,
           QStringLiteral("https://example/512x512.jpg"));
}

void MediaModelTest::exposesPlaybackIds() {
  MediaModel model;
  model.replace(QJsonArray{song(QStringLiteral("i.1"), QStringLiteral("11")),
                           song(QStringLiteral("i.2"), QStringLiteral("22"))});
  QCOMPARE(model.rowCount(), 2);
  QCOMPARE(model.playbackIds(),
...
void MediaModelTest::marksUnreleasedCatalogTrackUnavailable() {
    ...
    if (released) {
      attributes.insert(
          ...
          QJsonObject{{QStringLiteral("id"), id},
                      {QStringLiteral("kind"), QStringLiteral("song")}});
    }
  ...
  MediaModel model;
  model.replace({track(QStringLiteral("available"), true),
                 track(QStringLiteral("coming-soon"), false)});
...
void MediaModelTest::updatesLibraryStatus() {
  MediaModel model;
  model.replace(
      QJsonArray{song(QStringLiteral("i.123"), QStringLiteral("456"))});
