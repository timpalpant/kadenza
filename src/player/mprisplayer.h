...
public:
  ...
  QString desktopEntry() const {
    return QStringLiteral("io.github.timpalpant.kanzi");
  }
...
class MprisPlayerAdaptor : public QDBusAbstractAdaptor {
  ...
  Q_PROPERTY(
      QString PlaybackStatus READ playbackStatus NOTIFY propertiesChanged)
  Q_PROPERTY(QString LoopStatus READ loopStatus WRITE setLoopStatus NOTIFY
                 propertiesChanged)
  Q_PROPERTY(double Rate READ rate WRITE setRate)
  Q_PROPERTY(
      bool Shuffle READ shuffle WRITE setShuffle NOTIFY propertiesChanged)
