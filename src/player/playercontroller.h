...
class PlayerController : public QObject {
  ...
  Q_PROPERTY(bool restoringSession READ restoringSession NOTIFY
                 restoringSessionChanged)
  ...
  Q_PROPERTY(
      int currentQueueIndex READ currentQueueIndex NOTIFY queuePositionChanged)
  ...
  Q_PROPERTY(
      bool synchronizedLyrics READ synchronizedLyrics NOTIFY lyricsChanged)
  Q_PROPERTY(
      bool previewDetected READ previewDetected NOTIFY previewDetectedChanged)
...
signals:
  void tokensChanged(const QString &developerToken, const QString &userToken,
  ...
  void actionResult(const QString &kind, const QString &id, bool ok,
